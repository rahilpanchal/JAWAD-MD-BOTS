...
const config = {
  SESSION_ID: process.env.SESSION_ID || "KHAN-MD~PuhwUSrC#n2pkB0qf8zOz8czt8b7OtyV7xg5y1BlwA9991bAfZGM",
  ...
  BOT_NAME: process.env.BOT_NAME || "RAHUL-PANCHAL",
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "917017659124",
